          ...
          {INDUSTRIES.map((ind) => {
            ...
            return (
              <motion.div
                ...
                className="group flex flex-col items-center text-center p-6 rounded-2xl glass hover:border-amber-500/40 transition-all duration-300 cursor-default"
              >
                <div className="w-12 h-12 rounded-xl bg-amber-400/8 group-hover:bg-amber-400/18 flex items-center justify-center mb-4 transition-colors duration-300">
                  <Icon size={22} className="text-gray-400 group-hover:text-amber-400 transition-colors duration-300" />
                </div>
                <h3 className="text-sm font-semibold text-white leading-snug group-hover:text-amber-300 transition-colors duration-300">
                  {ind.title}
                </h3>
                <p className="mt-1.5 text-[11px] text-gray-600 leading-relaxed hidden sm:block">
