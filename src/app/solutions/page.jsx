...
const TESTIMONIALS = [
  { name: "Amit Sahu",    location: "Bhubaneswar", type: "Solar",      quote: "Soumyasi Power cut my factory's electricity bill by 72%. The installation was seamless — they handled everything from permits to commissioning." },
  { name: "Deepak Rath",  location: "Cuttack",     type: "EV Charging", quote: "The charging station at our mall has been running flawlessly for 18 months. Reliable hardware, smart access, zero downtime." },
  { name: "Sunita Mishra", location: "Puri",        type: "Industrial",  quote: "Their team upgraded our entire substation infrastructure. Professional execution, on-time delivery, and excellent post-install support." },
];
