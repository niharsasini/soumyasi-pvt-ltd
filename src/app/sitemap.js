export default function sitemap() {
  return [
    ...
    { url: "https://soumyasipower.com/solutions/solar-rooftop",           lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://soumyasipower.com/solutions/ev-charging",             lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://soumyasipower.com/solutions/wind-power",              lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://soumyasipower.com/solutions/industrial-power",        lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
