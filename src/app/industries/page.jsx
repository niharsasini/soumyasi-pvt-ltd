      ...
      <section className="pb-24 px-4 bg-brand-bg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-gold mb-3">Our Expertise</p>
            <h2 className="text-3xl sm:text-4xl font-bold font-display text-brand-ink">
              Industry-Specific Solutions
            </h2>
            <p className="mt-4 text-brand-brown max-w-2xl mx-auto">
              Soumyashree Power supports critical sectors with innovative electrical engineering solutions built for reliability.
            </p>
          </div>
