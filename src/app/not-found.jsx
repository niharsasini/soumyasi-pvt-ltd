    ...
    <div className="min-h-screen bg-[#FFFBF0] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-lg">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <span className="text-[72px] sm:text-[100px] md:text-[140px] font-bold font-display leading-none bg-gradient-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent select-none">
            404
          </span>
        </motion.div>
