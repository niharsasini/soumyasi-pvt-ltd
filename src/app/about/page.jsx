  ...
  return (
    <div className="bg-brand-bg text-brand-ink overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden bg-brand-bg">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <motion.div animate={{ x: [0,-25,0], y:[0,20,0] }} transition={{ duration:12, repeat:Infinity, ease:"easeInOut", delay:3 }}
            className="absolute bottom-[10%] right-[5%] h-56 w-56 rounded-full bg-amber-300/8 blur-3xl" />
        </div>
      ...
      <section className="py-24 px-4 bg-brand-bg">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-gold mb-4">What We Stand For</p>
            <h2 className="text-4xl sm:text-5xl font-bold font-display text-brand-ink">Mission &amp; Vision</h2>
          </div>
      ...
      <section className="py-24 px-4 bg-brand-section">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-gold mb-4">Our Principles</p>
            <h2 className="text-4xl sm:text-5xl font-bold font-display text-brand-ink">What Drives Us</h2>
          </div>
      ...
      <section className="py-24 px-4 bg-brand-bg">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-gold mb-4">The People Behind It</p>
            <h2 className="text-4xl sm:text-5xl font-bold font-display text-brand-ink">Our Leadership</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      <section className="py-24 px-4 bg-brand-section relative">
        ...
        <div className="max-w-4xl mx-auto" ref={tlRef}>
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.3em] uppercase text-brand-gold mb-4">How We Got Here</p>
            <h2 className="text-4xl sm:text-5xl font-bold font-display text-brand-ink">Our Journey</h2>
          </div>
